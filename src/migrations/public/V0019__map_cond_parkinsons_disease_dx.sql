CREATE TABLE map_cond_parkinsons_disease_dx
(
  diagnosis_cd        VARCHAR(15) NOT NULL,
  diagnosis_type_cd   VARCHAR(15) NOT NULL
);

INSERT INTO map_cond_parkinsons_disease_dx
(
    diagnosis_cd
  , diagnosis_type_cd
)
WITH main_codes AS (
  ...
  WHERE
    c2.concept_name in (E'Parkinson\'s disease'::text)
...
ANALYZE map_cond_parkinsons_disease_dx;
