CREATE TABLE map_cond_rheumatoid_arthritis_dx
(
  diagnosis_cd        VARCHAR(15) NOT NULL,
  diagnosis_type_cd   VARCHAR(15) NOT NULL
);

INSERT INTO map_cond_rheumatoid_arthritis_dx
(
    diagnosis_cd
  , diagnosis_type_cd
)
WITH main_codes AS (
  ...
  WHERE
    c2.concept_name = 'Rheumatoid arthritis'
...
ANALYZE map_cond_rheumatoid_arthritis_dx;
