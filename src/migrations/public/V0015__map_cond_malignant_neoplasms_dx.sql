CREATE TABLE map_cond_malignant_neoplasms_dx
(
  diagnosis_cd        VARCHAR(15) NOT NULL,
  diagnosis_type_cd   VARCHAR(15) NOT NULL
);

INSERT INTO map_cond_malignant_neoplasms_dx (
    diagnosis_cd
  , diagnosis_type_cd
)
WITH main_codes AS (
  ...
  WHERE
    ancestor.concept_name = 'Malignant neoplastic disease'
)
SELECT DISTINCT
...
ANALYZE map_cond_malignant_neoplasms_dx;
